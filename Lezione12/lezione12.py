...
print(movie_catalog.get_movies_by_director("Francis Ford Coppola"))
print("")
print(movie_catalog.get_movies_by_director("Quentin Tarantino"))
print("")
print(movie_catalog.get_movies_by_director("Steven Spielberg"))
print("")
movie_catalog.remove_movie("Apocalypse Now", "Francis Ford Coppola")
print(movie_catalog.get_movies_by_director("Francis Ford Coppola"))
print("")
print(movie_catalog.list_directors())
print(movie_catalog.search_movies_by_title("E"))
print(movie_catalog.search_movies_by_title("fiction"))
print(movie_catalog.search_movies_by_title("brasil"))
