...
CREATE TABLE public.attivitanonprogettuale (
    ...
    giorno date NOT NULL,
    oredurata timestamp without time zone NOT NULL
);
...
CREATE TABLE public.persona (
    ...
    stipendio public.denaro DEFAULT 0
);
...
CREATE TABLE public.progetto (
    ...
    fine date NOT NULL,
    budget public.denaro DEFAULT 0,
...
--
-- Name: persona persona_nome_cognome_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.persona
    ADD CONSTRAINT persona_nome_cognome_key UNIQUE (nome, cognome);
