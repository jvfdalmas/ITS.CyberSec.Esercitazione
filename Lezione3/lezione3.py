...
pizze = ['margheritta', 'mozzarella', 'fiore di zucca']
...
countingto20 = [number for number in range(1,21)]
print(countingto20)
...
#countingtomillion = [number for number in range(1_000_001)]
...
My_Pizza = ['mozzarella', 'pepperone', 'fior di zucca', 'capriciosa']
...
favorite_fruits = ["banana",  "orange", "pineapple"]
...
usernames = ['admin', 'jdalmas', 'mfontevecchia', 'bandreucci', 'rdinatale']
...
usernames = ['admin', 'jdalmas', 'mfontevecchia', 'bandreucci', 'rdinatale']
new_users = ['rfontevecchia', 'Jdalmas', 'apannonne', 'jvsoares', 'Rdinatale']
