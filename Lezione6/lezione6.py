...
class Person:
    ...
    def __init__(self, name: str, surname: str, taxpayers_id: str) -> None:
        ...
        self._taxpayers_id: str = taxpayers_id # attributo della classe
...
persona_1: Person = Person(name="Flavio", surname="Giorgi", taxpayers_id="DGDFVR")
